...
// Light Theme Colors (Medical Teal/Blue)
// Light Theme Colors (Modern Medical Teal)
val md_theme_light_primary = Color(0xFF008fa0) // Vibrant Teal
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFE0F7FA) // Very light teal
val md_theme_light_onPrimaryContainer = Color(0xFF00363D)
val md_theme_light_secondary = Color(0xFF4A6267)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFCCE8E6) // Soft pastel teal
...
val md_theme_light_errorContainer = Color(0xFFFFB2AC)
val md_theme_light_onError = Color(0xFFFFFFFF)
val md_theme_light_onErrorContainer = Color(0xFF410002)
val md_theme_light_background = Color(0xFFF5FBFB) // Cool White
...
val md_theme_light_surfaceVariant = Color(0xFFE0E5E5) // Lighter, cleaner grey
val md_theme_light_onSurfaceVariant = Color(0xFF3F484A)
val md_theme_light_outline = Color(0xFF6F797A)
val md_theme_light_surfaceContainer = Color(0xFFF0F7F8)
val md_theme_light_surfaceContainerHigh = Color(0xFFE6EFF1)
val md_theme_light_surfaceContainerLowest = Color(0xFFFFFFFF)

// Dark Theme Colors (Deep & Premium)
val md_theme_dark_primary = Color(0xFF40E0D0) // Glowing Turquoise
val md_theme_dark_onPrimary = Color(0xFF00373E)
...
val md_theme_dark_error = Color(0xFFFFA697)
val md_theme_dark_errorContainer = Color(0xFF93000A)
val md_theme_dark_onError = Color(0xFF690005)
val md_theme_dark_onErrorContainer = Color(0xFFFFDAD6)
val md_theme_dark_background = Color(0xFF0F1519) // Deep Blue-Black
val md_theme_dark_onBackground = Color(0xFFE1E3E3)
val md_theme_dark_surface = Color(0xFF161D22) // Slightly lighter than background
...
val md_theme_dark_surfaceContainer = Color(0xFF1E272C)
val md_theme_dark_surfaceContainerHigh = Color(0xFF283238)
val md_theme_dark_surfaceContainerLowest = Color(0xFF0C1013)
